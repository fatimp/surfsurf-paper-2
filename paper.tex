...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth, frame]{images/blob.png}
...
this comparison is on \cref{fig:fss-blob}. The maximal relative error for values
obtained with the fast algorithm is \textcolor{red}{insert value}.
\begin{figure*}[!pt]
  \centering
  \subfigure[$3\times 3$ kernel $H$]{
...
\cref{fig:fss-blob-5x5}. The maximal relative error is reduced to
