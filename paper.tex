...
overlapping balls and disks, whether or not our algorithm performs with the same
high accuracy in general is still an open question. In this section we develop a
...
\begin{figure*}[!hpt]
  \centering
  \subfigure[$3\times 3$ kernel $H$]{
    \includegraphics[width=\linewidth]{images/fss-blob-3x3.png}
    \label{fig:fss-blob-3x3}}
  \vskip\baselineskip
  \subfigure[$7\times 7$ kernel $H'$]{
    \includegraphics[width=\linewidth]{images/fss-blob-7x7.png}
...
\begin{figure*}[!hpt]
  \centering
  \subfigure[$3\times 3$ kernel $H$]{
    \includegraphics[width=\linewidth]{images/fss-ellipses-3x3.png}
    \label{fig:fss-ellipses-3x3}}
  \vskip\baselineskip
  \subfigure[$7\times 7$ kernel $H'$]{
    \includegraphics[width=\linewidth]{images/fss-ellipses-7x7.png}
