...
$(\varepsilon, 2R - \varepsilon) \cup (2R + \varepsilon, 1)$ (here we assume
image dimensions to be $1 \times 1 \times 1$ length units). Taking
$\varepsilon = 0.01$ we get $error = 0.006$ for filter $H$ and $error = 0.00017$
for filter $H'$.
