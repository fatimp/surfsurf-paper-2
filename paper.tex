...
\section{Algorithm for computation of surface functions for digital images}
\label{sec:algo}
...
\begin{figure}
  ...
  \caption[]{Left, center: images $A$ and $B$ used in the experiment for
    ...
    area equals to $1 / \sin \phi$.}
  \label{fig:experiment-setup}
\end{figure}
Take two 2D images like the ones on \cref{fig:experiment-setup}. Boundaries
between black and white areas cross each other at the angle $\phi$. We apply a
